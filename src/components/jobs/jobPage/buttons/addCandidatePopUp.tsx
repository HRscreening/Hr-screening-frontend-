...
//     if ((source === 'upload' && selectedFiles) || (source === 'cloud' && cloudUrl)) {
//       setIsProcessing(true);
//       setError(null);

//       try {
//         if (source === 'upload' && selectedFiles) {
//           const formData = new FormData();
//           formData.append('zip_file', selectedFiles);
...
//                       Upload one PDF/DOCX file, or a ZIP file with multiple resumes (PDF/DOCX, max 500MB).
//                     </p>
//                   </div>
//                 ) : (
...
//                           <p className="text-sm font-medium truncate">{selectedFiles.name}</p>
//                           <p className="text-xs text-muted-foreground">{formatFileSize(selectedFiles.size)}</p>
//                         </div>
//                       </div>
//                       <Button
//                         variant="ghost"
            ...
            {source === 'upload' && (
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">
                    Upload one or more PDF/DOCX files, or ZIP files with multiple resumes (max 500MB each).
                  </p>
                </div>
